...
public class MyCoordinatorLayout extends CoordinatorLayout {
    ...
    private boolean isTouchPointInBannerView;//触点是否在banner上
...
//                    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
      ...
      /*  LogUtil.I("consumed[1]===" + consumed[1]);
        LogUtil.I("isTouchPointInBannerView===" + !isTouchPointInBannerView);*/
    ...
    private int getNestedScrollViewMaxOffset() {
        ...
        if (nestedScrollView != null && nestedScrollView.getChildCount() > 0 && nsvMaxOffsetY == 0) {
            ...
            if (child != null && child instanceof VerticalLinearLayout) {
                ...
                //LogUtil.I("获取划出屏幕的最大距离==" + nsvMaxOffsetY);
            }
        }
